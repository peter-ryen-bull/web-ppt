...
export function Automatikk() {
  const T = 6;
  return (
    <Figur w={420} h={150} label="Tannhjul som går rundt ved siden av en sjekkliste som fyller seg selv ut">
...
export function EffektRad() {
  const deler = ["Datakvalitet", "Etterlevelse", "Selvbetjening", "Fremtidsrettet"];
  return (
    <Figur w={1000} h={150} label="Datakvalitet, etterlevelse, selvbetjening og fremtidsrettet">
      {deler.map((tekst, i) => {
        const cx = 125 + i * 250;
        return (
          <g key={tekst}>
